...
```go
import netbox "github.com/sherweb/go-netbox/v4/netbox"
```
...
## Documentation For Models
 ...
 - [AuthenticationCipher1](docs/AuthenticationCipher1.md)
 - [AuthenticationType](docs/AuthenticationType.md)
 - [AuthenticationType1](docs/AuthenticationType1.md)
 - [AuthenticationType2](docs/AuthenticationType2.md)
 - [AuthenticationType3](docs/AuthenticationType3.md)
 ...
 - [CircuitsCircuitsListStatusIcParameterInner](docs/CircuitsCircuitsListStatusIcParameterInner.md)
 ...
 - [CoreJobsListStatusIcParameterInner](docs/CoreJobsListStatusIcParameterInner.md)
 ...
 - [DcimCablesListStatusIcParameterInner](docs/DcimCablesListStatusIcParameterInner.md)
 - [DcimCablesListTypeIcParameterInner](docs/DcimCablesListTypeIcParameterInner.md)
 - [DcimConsolePortTemplatesListTypeParameter](docs/DcimConsolePortTemplatesListTypeParameter.md)
 - [DcimConsolePortsListDeviceStatusIcParameterInner](docs/DcimConsolePortsListDeviceStatusIcParameterInner.md)
 - [DcimConsolePortsListSpeedParameter](docs/DcimConsolePortsListSpeedParameter.md)
 - [DcimConsolePortsListTypeIcParameterInner](docs/DcimConsolePortsListTypeIcParameterInner.md)
 ...
 - [DcimFrontPortTemplatesListTypeIcParameterInner](docs/DcimFrontPortTemplatesListTypeIcParameterInner.md)
 - [DcimInterfaceTemplatesListPoeModeIcParameterInner](docs/DcimInterfaceTemplatesListPoeModeIcParameterInner.md)
 - [DcimInterfaceTemplatesListPoeTypeIcParameterInner](docs/DcimInterfaceTemplatesListPoeTypeIcParameterInner.md)
 - [DcimInterfaceTemplatesListTypeIcParameterInner](docs/DcimInterfaceTemplatesListTypeIcParameterInner.md)
 - [DcimInterfacesListDuplexIcParameterInner](docs/DcimInterfacesListDuplexIcParameterInner.md)
 - [DcimInterfacesListModeParameter](docs/DcimInterfacesListModeParameter.md)
 - [DcimLocationsListStatusIcParameterInner](docs/DcimLocationsListStatusIcParameterInner.md)
 - [DcimModuleTypesListAirflowParameter](docs/DcimModuleTypesListAirflowParameter.md)
 - [DcimModulesListStatusIcParameterInner](docs/DcimModulesListStatusIcParameterInner.md)
 - [DcimPowerFeedsListPhaseParameter](docs/DcimPowerFeedsListPhaseParameter.md)
 - [DcimPowerFeedsListStatusIcParameterInner](docs/DcimPowerFeedsListStatusIcParameterInner.md)
 ...
 - [DcimPowerOutletTemplatesListFeedLegIcParameterInner](docs/DcimPowerOutletTemplatesListFeedLegIcParameterInner.md)
 - [DcimPowerOutletTemplatesListTypeParameter](docs/DcimPowerOutletTemplatesListTypeParameter.md)
 - [DcimPowerOutletsListTypeIcParameterInner](docs/DcimPowerOutletsListTypeIcParameterInner.md)
 - [DcimPowerPortTemplatesListTypeParameter](docs/DcimPowerPortTemplatesListTypeParameter.md)
 - [DcimPowerPortsListTypeIcParameterInner](docs/DcimPowerPortsListTypeIcParameterInner.md)
 - [DcimRackTypesListFormFactorIcParameterInner](docs/DcimRackTypesListFormFactorIcParameterInner.md)
 - [DcimRackTypesListOuterUnitParameter](docs/DcimRackTypesListOuterUnitParameter.md)
 - [DcimRackTypesListWidthIcParameterInner](docs/DcimRackTypesListWidthIcParameterInner.md)
 ...
 - [DcimRacksListFormFactorIcParameterInner](docs/DcimRacksListFormFactorIcParameterInner.md)
 - [DcimRacksListStatusIcParameterInner](docs/DcimRacksListStatusIcParameterInner.md)
 - [DcimVirtualDeviceContextsListStatusIcParameterInner](docs/DcimVirtualDeviceContextsListStatusIcParameterInner.md)
 ...
 - [Encryption1](docs/Encryption1.md)
 - [End](docs/End.md)
 - [End1](docs/End1.md)
 - [Event](docs/Event.md)
 ...
 - [ExtrasCustomFieldsListTypeIcParameterInner](docs/ExtrasCustomFieldsListTypeIcParameterInner.md)
 ...
 - [ExtrasEventRulesListActionTypeIcParameterInner](docs/ExtrasEventRulesListActionTypeIcParameterInner.md)
 - [ExtrasJournalEntriesListKindIcParameterInner](docs/ExtrasJournalEntriesListKindIcParameterInner.md)
 - [ExtrasWebhooksListHttpMethodIcParameterInner](docs/ExtrasWebhooksListHttpMethodIcParameterInner.md)
 ...
 - [IpamFhrpGroupsListProtocolIcParameterInner](docs/IpamFhrpGroupsListProtocolIcParameterInner.md)
 - [IpamIpAddressesListRoleIcParameterInner](docs/IpamIpAddressesListRoleIcParameterInner.md)
 - [IpamIpAddressesListStatusIcParameterInner](docs/IpamIpAddressesListStatusIcParameterInner.md)
 - [IpamIpRangesListStatusIcParameterInner](docs/IpamIpRangesListStatusIcParameterInner.md)
 - [IpamPrefixesListStatusIcParameterInner](docs/IpamPrefixesListStatusIcParameterInner.md)
 ...
 - [VirtualizationClustersListStatusIcParameterInner](docs/VirtualizationClustersListStatusIcParameterInner.md)
 - [VpnIkePoliciesListModeIcParameterInner](docs/VpnIkePoliciesListModeIcParameterInner.md)
 - [VpnIkePoliciesListVersionIcParameterInner](docs/VpnIkePoliciesListVersionIcParameterInner.md)
 - [VpnIkeProposalsListAuthenticationAlgorithmIcParameterInner](docs/VpnIkeProposalsListAuthenticationAlgorithmIcParameterInner.md)
 - [VpnIkeProposalsListAuthenticationMethodIcParameterInner](docs/VpnIkeProposalsListAuthenticationMethodIcParameterInner.md)
 - [VpnIkeProposalsListEncryptionAlgorithmIcParameterInner](docs/VpnIkeProposalsListEncryptionAlgorithmIcParameterInner.md)
 - [VpnIkeProposalsListGroupIcParameterInner](docs/VpnIkeProposalsListGroupIcParameterInner.md)
 - [VpnIpsecPoliciesListPfsGroupIcParameterInner](docs/VpnIpsecPoliciesListPfsGroupIcParameterInner.md)
 - [VpnIpsecProfilesListModeIcParameterInner](docs/VpnIpsecProfilesListModeIcParameterInner.md)
 - [VpnL2vpnsListTypeIcParameterInner](docs/VpnL2vpnsListTypeIcParameterInner.md)
 - [VpnTunnelTerminationsListRoleIcParameterInner](docs/VpnTunnelTerminationsListRoleIcParameterInner.md)
 - [VpnTunnelsListEncapsulationIcParameterInner](docs/VpnTunnelsListEncapsulationIcParameterInner.md)
 - [VpnTunnelsListStatusIcParameterInner](docs/VpnTunnelsListStatusIcParameterInner.md)
 - [Webhook](docs/Webhook.md)
 - [WebhookRequest](docs/WebhookRequest.md)
 - [WirelessChannel](docs/WirelessChannel.md)
 - [WirelessChannel1](docs/WirelessChannel1.md)
 ...
 - [WirelessRole1](docs/WirelessRole1.md)
 - [WirelessWirelessLansListStatusIcParameterInner](docs/WirelessWirelessLansListStatusIcParameterInner.md)
